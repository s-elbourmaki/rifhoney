          ...
          <div className={`transition-all duration-1000 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  label: 'Email',
                  value: 'salimelbourmaki1@gmail.com',
                  icon: (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full gold-gradient text-[#1A1208] py-4 text-xs tracking-[0.3em] uppercase font-bold transition-all duration-300 ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:opacity-90 active:scale-[0.98]'
                      }`}
                  >
                    {loading ? (
