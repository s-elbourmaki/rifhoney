        ...
        {items.length > 0 && (
          <div className="flex-shrink-0 border-t border-[#C8860A20] px-6 py-5">
            ...
            <button
              ...
              className="w-full py-4 text-[11px] font-semibold tracking-[0.3em] uppercase transition-all duration-300 hover:opacity-90 active:scale-[0.98] flex items-center justify-center gap-2.5 rounded-sm"
              style={{
